...
Version  : 8.2.2
Release  : 138
URL      : https://github.com/harfbuzz/harfbuzz/archive/8.2.2/harfbuzz-8.2.2.tar.gz
Source0  : https://github.com/harfbuzz/harfbuzz/archive/8.2.2/harfbuzz-8.2.2.tar.gz
...
%prep
%setup -q -n harfbuzz-8.2.2
cd %{_builddir}/harfbuzz-8.2.2
%patch -P 1 -p1
pushd ..
cp -a harfbuzz-8.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697725134
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libharfbuzz-cairo.so.0.60822.0
/V3/usr/lib64/libharfbuzz-gobject.so.0.60822.0
/V3/usr/lib64/libharfbuzz-icu.so.0.60822.0
/V3/usr/lib64/libharfbuzz-subset.so.0.60822.0
/V3/usr/lib64/libharfbuzz.so.0.60822.0
/usr/lib64/libharfbuzz-cairo.so.0
/usr/lib64/libharfbuzz-cairo.so.0.60822.0
/usr/lib64/libharfbuzz-gobject.so.0
/usr/lib64/libharfbuzz-gobject.so.0.60822.0
/usr/lib64/libharfbuzz-icu.so.0
/usr/lib64/libharfbuzz-icu.so.0.60822.0
/usr/lib64/libharfbuzz-subset.so.0
/usr/lib64/libharfbuzz-subset.so.0.60822.0
/usr/lib64/libharfbuzz.so.0
/usr/lib64/libharfbuzz.so.0.60822.0
