...
Version  : 11.2.0
Release  : 154
URL      : https://github.com/harfbuzz/harfbuzz/archive/11.2.0/harfbuzz-11.2.0.tar.gz
Source0  : https://github.com/harfbuzz/harfbuzz/archive/11.2.0/harfbuzz-11.2.0.tar.gz
...
Requires: harfbuzz-man = %{version}-%{release}
...
%package man
Summary: man components for the harfbuzz package.
Group: Default

%description man
man components for the harfbuzz package.


%prep
%setup -q -n harfbuzz-11.2.0
cd %{_builddir}/harfbuzz-11.2.0
pushd ..
cp -a harfbuzz-11.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745849009
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dgraphite2=enabled \
-Dwith_libstdcxx=true  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dgraphite2=enabled \
-Dwith_libstdcxx=true  builddiravx2
...
/usr/share/gtk-doc/html/harfbuzz/api-index-10-0-0.html
...
/usr/share/gtk-doc/html/harfbuzz/api-index-11-2-0.html
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libharfbuzz-cairo.so.0.61120.0
/V3/usr/lib64/libharfbuzz-gobject.so.0.61120.0
/V3/usr/lib64/libharfbuzz-icu.so.0.61120.0
/V3/usr/lib64/libharfbuzz-subset.so.0.61120.0
/V3/usr/lib64/libharfbuzz.so.0.61120.0
/usr/lib64/libharfbuzz-cairo.so.0
/usr/lib64/libharfbuzz-cairo.so.0.61120.0
/usr/lib64/libharfbuzz-gobject.so.0
/usr/lib64/libharfbuzz-gobject.so.0.61120.0
/usr/lib64/libharfbuzz-icu.so.0
/usr/lib64/libharfbuzz-icu.so.0.61120.0
/usr/lib64/libharfbuzz-subset.so.0
/usr/lib64/libharfbuzz-subset.so.0.61120.0
/usr/lib64/libharfbuzz.so.0
/usr/lib64/libharfbuzz.so.0.61120.0
