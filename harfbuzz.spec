...
Source0  : https://github.com/harfbuzz/harfbuzz/archive/8.3.0/harfbuzz-8.3.0.tar.gz
...
%prep
%setup -q -n harfbuzz-8.3.0
cd %{_builddir}/harfbuzz-8.3.0
%patch -P 1 -p1
pushd ..
cp -a harfbuzz-8.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699891617
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libharfbuzz-cairo.so.0.60830.0
/V3/usr/lib64/libharfbuzz-gobject.so.0.60830.0
/V3/usr/lib64/libharfbuzz-icu.so.0.60830.0
/V3/usr/lib64/libharfbuzz-subset.so.0.60830.0
/V3/usr/lib64/libharfbuzz.so.0.60830.0
/usr/lib64/libharfbuzz-cairo.so.0
/usr/lib64/libharfbuzz-cairo.so.0.60830.0
/usr/lib64/libharfbuzz-gobject.so.0
/usr/lib64/libharfbuzz-gobject.so.0.60830.0
/usr/lib64/libharfbuzz-icu.so.0
/usr/lib64/libharfbuzz-icu.so.0.60830.0
/usr/lib64/libharfbuzz-subset.so.0
/usr/lib64/libharfbuzz-subset.so.0.60830.0
/usr/lib64/libharfbuzz.so.0
/usr/lib64/libharfbuzz.so.0.60830.0
