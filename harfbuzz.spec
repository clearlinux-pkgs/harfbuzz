...
Version  : 8.5.0
Release  : 142
URL      : https://github.com/harfbuzz/harfbuzz/archive/8.5.0/harfbuzz-8.5.0.tar.gz
Source0  : https://github.com/harfbuzz/harfbuzz/archive/8.5.0/harfbuzz-8.5.0.tar.gz
...
%prep
%setup -q -n harfbuzz-8.5.0
cd %{_builddir}/harfbuzz-8.5.0
%patch -P 1 -p1
pushd ..
cp -a harfbuzz-8.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715697339
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libharfbuzz-cairo.so.0.60850.0
/V3/usr/lib64/libharfbuzz-gobject.so.0.60850.0
/V3/usr/lib64/libharfbuzz-icu.so.0.60850.0
/V3/usr/lib64/libharfbuzz-subset.so.0.60850.0
/V3/usr/lib64/libharfbuzz.so.0.60850.0
/usr/lib64/libharfbuzz-cairo.so.0
/usr/lib64/libharfbuzz-cairo.so.0.60850.0
/usr/lib64/libharfbuzz-gobject.so.0
/usr/lib64/libharfbuzz-gobject.so.0.60850.0
